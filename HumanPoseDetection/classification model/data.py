...
CORRECT_POSES = {
    ...
    "Downward Dog": {
     ...
     "Chair Pose": {
        BodyPart.LEFT_SHOULDER: Point(0.3, 0.2),  # Left shoulder
        BodyPart.RIGHT_SHOULDER: Point(0.7, 0.2),  # Right shoulder
        BodyPart.LEFT_ELBOW: Point(0.2, 0.3),      # Left elbow
        BodyPart.RIGHT_ELBOW: Point(0.8, 0.3),     # Right elbow
        BodyPart.LEFT_HIP: Point(0.3, 0.5),        # Left hip
        BodyPart.RIGHT_HIP: Point(0.7, 0.5),       # Right hip
        BodyPart.LEFT_KNEE: Point(0.3, 0.7),       # Left knee
        BodyPart.RIGHT_KNEE: Point(0.7, 0.7),      # Right knee
        BodyPart.LEFT_ANKLE: Point(0.3, 0.9),      # Left ankle
        BodyPart.RIGHT_ANKLE: Point(0.7, 0.9),     # Right ankle
    },
      "Tree Pose": {
    BodyPart.LEFT_SHOULDER: Point(0.3, 0.2),  # Left shoulder (x, y, confidence)
    BodyPart.RIGHT_SHOULDER: Point(0.7, 0.2), # Right shoulder
    BodyPart.LEFT_ELBOW: Point(0.2, 0.3),     # Left elbow
    BodyPart.RIGHT_ELBOW: Point(0.8, 0.3),    # Right elbow
    BodyPart.LEFT_HIP: Point(0.3, 0.5),       # Left hip
    ...
    BodyPart.LEFT_ANKLE: Point(0.3, 0.9),     # Left ankle
    BodyPart.RIGHT_ANKLE: Point(0.7, 0.9),    # Right ankle
    BodyPart.LEFT_WRIST: Point(0.1, 0.4),     # Left wrist
    BodyPart.RIGHT_WRIST: Point(0.9, 0.4 ),    # Right wrist
